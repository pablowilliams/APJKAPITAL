...
const pageConfig: Record<Page, {
  ...
  home: {
    ...
    enterDur: 1.2, holdDur: 0.8, exitDur: 0.9,
  },
  about: {
    ...
    enterDur: 1.1, holdDur: 0.9, exitDur: 0.8,
  },
  strategy: {
    ...
    enterDur: 1.0, holdDur: 0.9, exitDur: 0.8,
  },
  performance: {
    ...
    enterDur: 1.2, holdDur: 1.0, exitDur: 0.8,
  },
  team: {
    ...
    enterDur: 1.1, holdDur: 1.0, exitDur: 0.8,
  },
  contact: {
    ...
    enterDur: 1.3, holdDur: 0.8, exitDur: 0.9,
  },
  research: {
    ...
    enterDur: 1.2, holdDur: 0.9, exitDur: 0.8,
  },
}
